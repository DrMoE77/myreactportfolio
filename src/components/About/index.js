            ...
            <div className='body-div' id="about-div">
                <Col id="about-div-text" >
                    ...
                    <p className='about_text'>
                        I am a Pharmacist, training to be a lawyer. At the moment I am available for locuming mostly in Sydney - but can travel to other states and rural NSW. I am currently working on a Medication reminder app and data science collection for my research with UTS-ASU. The most recent pharmacy work for me was at Priceline Pharmacies and Chemist Warehouse and legal work was HIV AIDS legal centre (HALC) and Kamyia Legal. In 2019 I went overseas for a while with my family and when I returned, I was studying full-time for my Master of Pharmaceutical Medicine and doing some locum work. 
